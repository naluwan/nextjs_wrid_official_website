...
const Footer = () => {
  ...
  return (
    <footer className='3xl:px-0 mx-auto mt-8 h-auto max-w-[1440px] px-6 py-4 text-[#333] lg:px-20'>
      <div className='flex h-52 justify-evenly max-md:flex-col max-md:items-center'>
        <div className='flex w-full flex-col items-start justify-between'>
          ...
          <div className='flex items-center justify-center gap-x-2 py-4 md:mt-2 md:justify-start md:py-0'>
