...
export const collectionsData = [
  ...
  // },
  {
    ...
    category: 'home',
    images: [
      { id: 17, name: '新竹1', src: collection4.image1.src },
      { id: 18, name: '新竹2', src: collection4.image2.src },
      { id: 19, name: '新竹3', src: collection4.image3.src },
      { id: 20, name: '新竹4', src: collection4.image4.src },
      { id: 21, name: '新竹5', src: collection4.image5.src },
      { id: 22, name: '新竹6', src: collection4.image6.src },
      { id: 23, name: '新竹7', src: collection4.image7.src },
      { id: 24, name: '新竹8', src: collection4.image8.src },
    ],
    order: 3,
  },
  {
